            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="text-center mt-3">Editar Dependencias</h2>
                        <form action="editDependence.php" method="post" class="mt-3 w-50 m-auto">
                            <input class="form-control" type="hidden" name="id" value="<?php echo $row->id ?>">
                            <label class="form-label">Nombre dependencia</label>
                            <input class="form-control" type="text" name="dependencia" value="<?php echo $row->dependencia ?>">                           
                            <br>
                                ...
                                <table id="datatablesSimple">
	        			            ...
	        			            while ($filas = $ejecutar->fetch_object()){
	    			    	            ...
	    			    	            echo "<td class='text-center'>
    				        		            <a class='btn btn-info' href='editarDependencia.php?id=".$filas->id."'>Editar</a>
        						                <a class='btn btn-danger' href='eliminarDependencia.php?id=".$filas->id."'>eliminar</a>	
						                    </td>";
					                    echo "</tr>";
				                        }			
			                        ?>                                                                               
