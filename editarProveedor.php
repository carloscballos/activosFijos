            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="text-center mt-3">Editar Proveedor</h2>
                        <form action="editSupplier.php" method="post" class="mt-3 w-50 m-auto">
                            <input class="form-control" type="hidden" name="id" value="<?php echo $row->id ?>">
                            <label class="form-label">Nit</label>
                            <input class="form-control" type="number" name="nit" value="<?php echo $row->nit ?>">                          
                            <label class="form-label">Razon Social</label>
                            <input class="form-control" type="text" name="razonSocial" value="<?php echo $row->razonSocial ?>">                            
                            <br>
                    ...
                    <div class="card-body">
                                <table id="datatablesSimple">
	        			            ...
	        			            while ($filas = $ejecutar->fetch_object()){
                					    echo "<tr>";					
			                		    echo "<td class='text-center'>".$filas->nit."</td>";            	    				       			                		
			                		    echo "<td class='text-center'>".$filas->razonSocial."</td>";            	    				       			                		
	    			    	            echo "<td class='text-center'>
    				        		            <a class='btn btn-info' href='editarProveedor.php?id=".$filas->id."'>Editar</a>
        						                <a class='btn btn-danger' href='eliminarProveedor.php?id=".$filas->id."'>eliminar</a>	
						                    </td>";
					                    echo "</tr>";
				                        }			
			                        ?>                                                                               
