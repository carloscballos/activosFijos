            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="text-center mt-3">Editar Oficina</h2>
                        <form action="EditOffice.php" method="post" class="mt-3 w-50 m-auto">
                            <input class="form-control" type="hidden" name="id" value="<?php echo $row->id ?>">
                            <label class="form-label">Nombre Oficina</label>
                            <input class="form-control" type="text" name="oficina" value="<?php echo $row->oficina ?>">                           
                            <br>
