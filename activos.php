<?php
    ...
    $depreciacion = $_POST['responsable'];   
    $query = "INSERT INTO activos (codigo,referencia,serial,dependencia,oficina,proveedor,estado,fechaCompra,fechaGarantia,depreciacion) VALUES ('$codigo','$referencia','$serial','$dependencia','$oficina','$proveedor','$estado','$fCompra','$fGarantia','$depreciacion')";
